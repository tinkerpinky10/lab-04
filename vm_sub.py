...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("kdvasque/ipinfo")
    client.subscribe("kdvasque/dateInfo")
    client.subscribe("kdvasque/timeInfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("kdvasque/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("kdvasque/dateInfo", on_message_from_dateInfo)
    client.message_callback_add("kdvasque/timeInfo", on_message_from_timeInfo)
...
def on_message_from_dateInfo(client, userdata,message):
   print("dateInfo:")
   print("Custom callback - The Date: " +message.payload.decode())

def on_message_from_timeInfo(client, userdata, message):
   print("timeInfo:")
   print("Custom callback - The Time: " +message.payload.decode())
